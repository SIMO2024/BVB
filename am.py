...
def main_apv():
    ...
    try:
        ...
        kok = open('/sdcard/.abdou.key.txt', 'w')
        kok.write(myid + imt)
        kok.close()
    
        input(' Exit And Again Run The Command');os.system('python DOD.py')
        tks = ('Hello%20abdou%20Owner%20Abdou%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://t.me/SIMO_TM2+?text='+tks)

    r1 = requests.get('https://github.com/SIMO2024/ADFRAF/blob/main/key.txt').text
    ...
    if key1 in r1:
        ...
        tks = ('Hello%20abdou%20Owner%20andou tool%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://t.me/SIMO_TM2?text='+tks)
        main_apv() 
main_apv()          
